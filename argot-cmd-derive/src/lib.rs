...
/// and its fields.
///
/// The generated `command()` implementation calls [`argot_cmd::Command::builder`]
...
fn derive_impl(input: DeriveInput) -> syn::Result<TokenStream2> {
    ...
    let mut builder_tokens = quote! {
        ::argot_cmd::Command::builder(#canonical)
    };
    ...
    for field in named.iter() {
        ...
        if fa.positional {
            ...
            let mut arg_builder = quote! { ::argot_cmd::Argument::builder(#arg_name) };
            if fa.required {
            ...
            let mut flag_builder = quote! { ::argot_cmd::Flag::builder(#flag_name) };
    ...
    Ok(quote! {
        impl #impl_generics ::argot_cmd::ArgotCommand for #ident #ty_generics #where_clause {
            fn command() -> ::argot_cmd::Command {
                #builder_tokens
            }
        }
    })
